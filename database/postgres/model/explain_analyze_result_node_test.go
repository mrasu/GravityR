...
func TestParseExplainAnalyzeResultLineNode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			nest, parsedLine, err := model.ParseExplainAnalyzeResultLineNode(tt.lines)
...
func TestExplainAnalyzeResultLineNode_EstimatedTotalTime(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			l := model.ExplainAnalyzeResultNode{ActualTimeAvg: tt.avg, ActualLoopCount: tt.loop}
...
func TestExplainAnalyzeResultLineNode_Title(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			l := model.ExplainAnalyzeResultNode{Lines: tt.lines}
