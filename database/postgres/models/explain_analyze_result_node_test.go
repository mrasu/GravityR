...
func TestParseExplainAnalyzeResultLineNode(t *testing.T) {
	tests := []struct {
		...
		lines        []string
		expectedNest int
		expectedLine *models.ExplainAnalyzeResultNode
	}{
		{
			name: "simple",
			lines: []string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			nest, parsedLine, err := models.ParseExplainAnalyzeResultLineNode(tt.lines)
...
func TestExplainAnalyzeResultLineNode_EstimatedTotalTime(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			l := models.ExplainAnalyzeResultNode{ActualTimeAvg: tt.avg, ActualLoopCount: tt.loop}
...
func TestExplainAnalyzeResultLineNode_Title(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			l := models.ExplainAnalyzeResultNode{Lines: tt.lines}
