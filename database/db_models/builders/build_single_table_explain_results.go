...
func BuildSingleTableExplainResults(root ExplainNode) []*db_models.SingleTableExplainResult {
	var trees []*singleTableTree
	sb := singleTableExplainResultsBuilder{}
	sb.toSingleTableTreeRecursive(&trees, root, nil)

	var res []*db_models.SingleTableExplainResult
	for _, tree := range trees {
		res = append(res, &db_models.SingleTableExplainResult{
